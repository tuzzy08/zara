...
26. Runtime orchestration standardization: ISSUE-133 through ISSUE-135 are implemented; ISSUE-136 and ISSUE-137 are pending. This slice now has the turn runtime packet baseline, model-backed packet-writing intent classification, and discretionary agent toolbelts with structured results; it still needs structured transfer context and broader edge-case policy guards across builder, runtime, sandbox, and architecture docs.
