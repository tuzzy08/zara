...
27. Runtime observability and evals: ISSUE-138 and ISSUE-139 are implemented; ISSUE-140 remains pending. The current baseline instruments packet-backed runtime decisions through OpenTelemetry, exports redacted AI traces to LangSmith when configured, and runs separate LangSmith/Vitest regression scorecards for intent, tools, transfers, policy guards, and end-to-end turns.
