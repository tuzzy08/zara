...
Website crawl refresh compares approved page URLs and content hashes against the latest crawl. Added pages create new drafts, changed pages create update drafts, and removed pages create deletion drafts. Runtime retrieval never performs live website search during calls.
