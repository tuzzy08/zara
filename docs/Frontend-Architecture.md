...
- Platform-admin agent class templates own base prompts plus routing descriptions/examples; tenant builders create reusable concrete agents in the tenant Agents library and can apply those agents to workflow nodes as snapshots.
